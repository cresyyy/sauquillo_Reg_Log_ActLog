							...
							<div class="card-body p-4 p-lg-5 text-black">
								...
								<form action="core/handleForms.php" method="POST">
									<div class="d-flex align-items-center mb-3 pb-1">
										...
										<span class="h1 fw-bold mb-0">Insert New Applicant</span>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-outline mb-3">
												...
												<input type="text" name="resume_url" class="form-control form-control-lg" />
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-outline mb-4">
												...
												<input type="text" name="years_of_experience" class="form-control form-control-lg" />
											</div>
											...
											<div class="form-outline mb-4">
												...
												<input type="text" name="license_num" class="form-control form-control-lg" />
											</div>

											<div class="pt-4 mt-4">
												<input type="submit" value="Insert User" name="insertUserBtn" class="btn btn-dark btn-lg btn-block" style="width:49%; background-color: #06b2b6; border:none;" />
												<button type="button" onclick="window.location.href='index.php';" class="btn btn-dark btn-lg btn-block" style="width:49%; background-color: #ef315d; border:none;">Cancel</button>
											</div>
										</div>
									</div>
								</form>
